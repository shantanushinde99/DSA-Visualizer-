...
export default async function GraphTraversalPage() {
  const content = await fs.readFile(
    path.join(process.cwd(), "content", "graph-traversal.md"),
    "utf-8"
  );
  ...
  return (
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="mb-8">
        <h1 className="text-4xl font-bold mb-2">BFS & DFS Graph Traversal</h1>
        <p className="text-muted-foreground">
          Visualize breadth-first and depth-first search algorithms
        </p>
      </div>
